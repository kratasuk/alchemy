...
// `not_relevant` — особый сигнал «работа не главная ось», не pain.
// Параллельно `all_good` в Q6. Влияет на промпт: блок 3 строится без
// упоминания работы, абзац 1 блока 5b пропускается / переключается.
const WORK_PAIN_LABELS = {
  ...
  not_relevant: 'Работа не актуальна'
};
