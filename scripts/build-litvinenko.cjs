...
function buildArticle() {
  ...
  out.push(`<link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400;1,500&family=Inter+Tight:wght@400;500;600&family=PT+Serif:ital,wght@0,400;0,700;1,400;1,700&display=swap" rel="stylesheet">`);
  out.push(`<style>`);
  out.push(`  :root {
    --bg: #f3ece0;
    --paper: #faf6ee;
