...
function buildArticle() {
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width: 640px) {
    ...
    /* Mobile sizes — Inter body needs less of a bump than Cormorant did. */
    .story-section p { font-size: 18px; line-height: 1.65; }
    ...
    .story-section ul.story-contrast li { font-size: 17px; }
